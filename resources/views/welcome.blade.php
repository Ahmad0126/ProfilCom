        ...
        <div class="container-fluid" id="content">
            <section class="section-wrapper" id="aboutme-section">
                <div class="section-heading">
                    <h5 class="section-title border border-bottom-0 border-1 border-dark ms-3">Visi dan Misi</h5>
                </div>
                <div class="section-content">
                    <div class="row pd-ltr-20 xs-pd-20-10 aboutme-section-wrapper border border-1 border-dark rounded-5">
            ...
            <section class="section-wrapper" id="berita-section">
                <div class="section-heading">
                    <h5 class="section-title border border-bottom-0 border-1 border-dark ms-3">Berita</h5>
                </div>
                <div class="section-content">
                    <div class="row pd-ltr-20 xs-pd-20-10 berita-section-wrapper border border-1 border-dark rounded-5">
                        <div class="col-sm-4 border-1 p-3 p-md-5">
                            <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image border border-1 border-dark img-fluid mx-auto" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false">
                                <title>Placeholder</title>
                                <rect width="100%" height="100%" fill="var(--bs-secondary-bg)"></rect><text x="50%" y="50%" fill="var(--bs-secondary-color)" dy=".3em">500x500</text>
